...
for (col_name in numerical_predictors) {
...
Categorical values not included
...
for (predictor_col in numerical_predictors) {
...
To convert categorical values, replace categorical variable with m indicator variables, where m = number of categories
